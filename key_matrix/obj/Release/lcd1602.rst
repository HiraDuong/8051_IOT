      ...
      000067                        349 _LCD_Send_Command:
                           ...
                           000001   356 	ar1 = 0x01
                           000000   357 	ar0 = 0x00
      000067 85 82 80         [24]  358 	mov	_P0,dpl
                                    359 ;	lcd1602.c:9: LCD_RS=0; //Chon thanh ghi lenh
                                    360 ;	assignBit
      00006A C2 A6            [12]  361 	clr	_P2_6
                                    362 ;	lcd1602.c:10: LCD_RW=0; //De ghi du lieu
                                    363 ;	assignBit
      00006C C2 A5            [12]  364 	clr	_P2_5
                                    365 ;	lcd1602.c:11: LCD_EN=1;
                                    366 ;	assignBit
      00006E D2 A7            [12]  367 	setb	_P2_7
                                    368 ;	lcd1602.c:12: Delay_us(100);
      000070 90 00 64         [24]  369 	mov	dptr,#0x0064
      000073 12 01 53         [24]  370 	lcall	_Delay_us
                                    371 ;	lcd1602.c:13: LCD_EN=0;
                                    372 ;	assignBit
      000076 C2 A7            [12]  373 	clr	_P2_7
                                    374 ;	lcd1602.c:14: Wait_For_LCD(); //Doi cho LCD san sang
      000078 12 00 7E         [24]  375 	lcall	_Wait_For_LCD
                                    376 ;	lcd1602.c:15: LCD_EN=1;
                                    377 ;	assignBit
      00007B D2 A7            [12]  378 	setb	_P2_7
                                    379 ;	lcd1602.c:16: }
      00007D 22               [24]  380 	ret
                                    381 ;------------------------------------------------------------
                                    ...
                                    387 ;	-----------------------------------------
      00007E                        388 _Wait_For_LCD:
                                    389 ;	lcd1602.c:20: Delay_us(100);
      00007E 90 00 64         [24]  390 	mov	dptr,#0x0064
                                    391 ;	lcd1602.c:21: }
      000081 02 01 53         [24]  392 	ljmp	_Delay_us
                                    393 ;------------------------------------------------------------
                                    ...
                                    399 ;	-----------------------------------------
      000084                        400 _LCD_init:
                                    401 ;	lcd1602.c:24: LCD_Send_Command(0x38); //Chon che do 8 bit, 2 hang cho LCD
      000084 75 82 38         [24]  402 	mov	dpl,#0x38
      000087 12 00 67         [24]  403 	lcall	_LCD_Send_Command
                                    404 ;	lcd1602.c:25: LCD_Send_Command(0x0E); //Bat hien thi, nhap nhay con tro
      00008A 75 82 0E         [24]  405 	mov	dpl,#0x0e
      00008D 12 00 67         [24]  406 	lcall	_LCD_Send_Command
                                    407 ;	lcd1602.c:26: LCD_Send_Command(0x01); //Xoa man hinh
      000090 75 82 01         [24]  408 	mov	dpl,#0x01
      000093 12 00 67         [24]  409 	lcall	_LCD_Send_Command
                                    410 ;	lcd1602.c:27: LCD_Send_Command(0x80); //Ve dau dong
      000096 75 82 80         [24]  411 	mov	dpl,#0x80
                                    412 ;	lcd1602.c:28: }
      000099 02 00 67         [24]  413 	ljmp	_LCD_Send_Command
                                    414 ;------------------------------------------------------------
                                    ...
                                    422 ;	-----------------------------------------
      00009C                        423 _LCD_Write_One_Char:
      00009C 85 82 80         [24]  424 	mov	_P0,dpl
                                    425 ;	lcd1602.c:34: LCD_RS=1; //Chon thanh ghi du lieu
                                    426 ;	assignBit
      00009F D2 A6            [12]  427 	setb	_P2_6
                                    428 ;	lcd1602.c:35: LCD_RW=0;
                                    429 ;	assignBit
      0000A1 C2 A5            [12]  430 	clr	_P2_5
                                    431 ;	lcd1602.c:36: LCD_EN=1;
                                    432 ;	assignBit
      0000A3 D2 A7            [12]  433 	setb	_P2_7
                                    434 ;	lcd1602.c:37: Delay_us(10);
      0000A5 90 00 0A         [24]  435 	mov	dptr,#0x000a
      0000A8 12 01 53         [24]  436 	lcall	_Delay_us
                                    437 ;	lcd1602.c:38: LCD_EN=0;
                                    438 ;	assignBit
      0000AB C2 A7            [12]  439 	clr	_P2_7
                                    440 ;	lcd1602.c:39: Wait_For_LCD();
      0000AD 12 00 7E         [24]  441 	lcall	_Wait_For_LCD
                                    442 ;	lcd1602.c:40: LCD_EN=1;
                                    443 ;	assignBit
      0000B0 D2 A7            [12]  444 	setb	_P2_7
                                    445 ;	lcd1602.c:41: }
      0000B2 22               [24]  446 	ret
                                    447 ;------------------------------------------------------------
                                    ...
                                    456 ;	-----------------------------------------
      0000B3                        457 _LCD_Write_String:
                                    458 ;	lcd1602.c:46: length=strlen(s); //Lay do dai xau
      0000B3 AD 82            [24]  459 	mov	r5,dpl
      0000B5 AE 83            [24]  460 	mov	r6,dph
      0000B7 AF F0            [24]  461 	mov	r7,b
      0000B9 C0 07            [24]  462 	push	ar7
      0000BB C0 06            [24]  463 	push	ar6
      0000BD C0 05            [24]  464 	push	ar5
      0000BF 12 02 64         [24]  465 	lcall	_strlen
      0000C2 AB 82            [24]  466 	mov	r3,dpl
      0000C4 AC 83            [24]  467 	mov	r4,dph
      0000C6 D0 05            [24]  468 	pop	ar5
      0000C8 D0 06            [24]  469 	pop	ar6
      0000CA D0 07            [24]  470 	pop	ar7
                                    471 ;	lcd1602.c:47: while(length!=0)
      0000CC                        472 00101$:
      0000CC EB               [12]  473 	mov	a,r3
      0000CD 60 27            [24]  474 	jz	00104$
                                    475 ;	lcd1602.c:49: LCD_Write_One_Char(*s); //Ghi ra LCD gia tri duoc tro boi con tro
      0000CF 8D 82            [24]  476 	mov	dpl,r5
      0000D1 8E 83            [24]  477 	mov	dph,r6
      0000D3 8F F0            [24]  478 	mov	b,r7
      0000D5 12 02 7C         [24]  479 	lcall	__gptrget
      0000D8 FC               [12]  480 	mov	r4,a
      0000D9 A3               [24]  481 	inc	dptr
      0000DA AD 82            [24]  482 	mov	r5,dpl
      0000DC AE 83            [24]  483 	mov	r6,dph
      0000DE 8C 82            [24]  484 	mov	dpl,r4
      0000E0 C0 07            [24]  485 	push	ar7
      0000E2 C0 06            [24]  486 	push	ar6
      0000E4 C0 05            [24]  487 	push	ar5
      0000E6 C0 03            [24]  488 	push	ar3
      0000E8 12 00 9C         [24]  489 	lcall	_LCD_Write_One_Char
      0000EB D0 03            [24]  490 	pop	ar3
      0000ED D0 05            [24]  491 	pop	ar5
      0000EF D0 06            [24]  492 	pop	ar6
      0000F1 D0 07            [24]  493 	pop	ar7
                                    494 ;	lcd1602.c:50: s++; //Tang con tro
                                    495 ;	lcd1602.c:51: length--;
      0000F3 1B               [12]  496 	dec	r3
      0000F4 80 D6            [24]  497 	sjmp	00101$
      0000F6                        498 00104$:
                                    499 ;	lcd1602.c:53: }
      0000F6 22               [24]  500 	ret
                                    501 ;------------------------------------------------------------
                                    ...
                                    511 ;	-----------------------------------------
      0000F7                        512 _LCD_GotoXY:
      0000F7 AF 82            [24]  513 	mov	r7,dpl
                                    514 ;	lcd1602.c:58: if (row == 2)
      0000F9 BF 02 08         [24]  515 	cjne	r7,#0x02,00102$
                                    516 ;	lcd1602.c:59: LCD_Send_Command(0xC0);      //cursor to fist col in row 2
      0000FC 75 82 C0         [24]  517 	mov	dpl,#0xc0
      0000FF 12 00 67         [24]  518 	lcall	_LCD_Send_Command
      000102 80 06            [24]  519 	sjmp	00112$
      000104                        520 00102$:
                                    521 ;	lcd1602.c:61: LCD_Send_Command(0x80);      //cursor to fist col in row 1 (default)
      000104 75 82 80         [24]  522 	mov	dpl,#0x80
      000107 12 00 67         [24]  523 	lcall	_LCD_Send_Command
                                    524 ;	lcd1602.c:62: for (i = 0; i < col; i++)
      00010A                        525 00112$:
      00010A 7F 00            [12]  526 	mov	r7,#0x00
      00010C                        527 00106$:
      00010C C3               [12]  528 	clr	c
      00010D EF               [12]  529 	mov	a,r7
      00010E 95 08            [12]  530 	subb	a,_LCD_GotoXY_PARM_2
      000110 50 0D            [24]  531 	jnc	00108$
                                    532 ;	lcd1602.c:63: LCD_Send_Command(0x14);      //cursor to fist col in row 1 (default)
      000112 75 82 14         [24]  533 	mov	dpl,#0x14
      000115 C0 07            [24]  534 	push	ar7
      000117 12 00 67         [24]  535 	lcall	_LCD_Send_Command
      00011A D0 07            [24]  536 	pop	ar7
                                    537 ;	lcd1602.c:62: for (i = 0; i < col; i++)
      00011C 0F               [12]  538 	inc	r7
      00011D 80 ED            [24]  539 	sjmp	00106$
      00011F                        540 00108$:
                                    541 ;	lcd1602.c:64: }
      00011F 22               [24]  542 	ret
                                    543 ;------------------------------------------------------------
                                    ...
                                    553 ;	-----------------------------------------
      000120                        554 _Delay_ms:
      000120 AE 82            [24]  555 	mov	r6,dpl
      000122 AF 83            [24]  556 	mov	r7,dph
                                    557 ;	lcd1602.c:69: for(i=0;i<1000;i++)
      000124 7C 00            [12]  558 	mov	r4,#0x00
      000126 7D 00            [12]  559 	mov	r5,#0x00
                                    560 ;	lcd1602.c:71: for(j=0;j<interval;j++);
      000128                        561 00111$:
      000128 7A 00            [12]  562 	mov	r2,#0x00
      00012A 7B 00            [12]  563 	mov	r3,#0x00
      00012C                        564 00104$:
      00012C C3               [12]  565 	clr	c
      00012D EA               [12]  566 	mov	a,r2
      00012E 9E               [12]  567 	subb	a,r6
      00012F EB               [12]  568 	mov	a,r3
      000130 64 80            [12]  569 	xrl	a,#0x80
      000132 8F F0            [24]  570 	mov	b,r7
      000134 63 F0 80         [24]  571 	xrl	b,#0x80
      000137 95 F0            [12]  572 	subb	a,b
      000139 50 07            [24]  573 	jnc	00107$
      00013B 0A               [12]  574 	inc	r2
      00013C BA 00 ED         [24]  575 	cjne	r2,#0x00,00104$
      00013F 0B               [12]  576 	inc	r3
      000140 80 EA            [24]  577 	sjmp	00104$
      000142                        578 00107$:
                                    579 ;	lcd1602.c:69: for(i=0;i<1000;i++)
      000142 0C               [12]  580 	inc	r4
      000143 BC 00 01         [24]  581 	cjne	r4,#0x00,00126$
      000146 0D               [12]  582 	inc	r5
      000147                        583 00126$:
      000147 C3               [12]  584 	clr	c
      000148 EC               [12]  585 	mov	a,r4
      000149 94 E8            [12]  586 	subb	a,#0xe8
      00014B ED               [12]  587 	mov	a,r5
      00014C 64 80            [12]  588 	xrl	a,#0x80
      00014E 94 83            [12]  589 	subb	a,#0x83
      000150 40 D6            [24]  590 	jc	00111$
                                    591 ;	lcd1602.c:73: }
      000152 22               [24]  592 	ret
                                    593 ;------------------------------------------------------------
                                    ...
                                    602 ;	-----------------------------------------
      000153                        603 _Delay_us:
      000153 AE 82            [24]  604 	mov	r6,dpl
      000155 AF 83            [24]  605 	mov	r7,dph
                                    606 ;	lcd1602.c:78: for(j=0;j<interval;j++);
      000157 7C 00            [12]  607 	mov	r4,#0x00
      000159 7D 00            [12]  608 	mov	r5,#0x00
      00015B                        609 00103$:
      00015B C3               [12]  610 	clr	c
      00015C EC               [12]  611 	mov	a,r4
      00015D 9E               [12]  612 	subb	a,r6
      00015E ED               [12]  613 	mov	a,r5
      00015F 64 80            [12]  614 	xrl	a,#0x80
      000161 8F F0            [24]  615 	mov	b,r7
      000163 63 F0 80         [24]  616 	xrl	b,#0x80
      000166 95 F0            [12]  617 	subb	a,b
      000168 50 07            [24]  618 	jnc	00105$
      00016A 0C               [12]  619 	inc	r4
      00016B BC 00 ED         [24]  620 	cjne	r4,#0x00,00103$
      00016E 0D               [12]  621 	inc	r5
      00016F 80 EA            [24]  622 	sjmp	00103$
      000171                        623 00105$:
                                    624 ;	lcd1602.c:79: }
      000171 22               [24]  625 	ret
                                    626 	.area CSEG    (CODE)
                                    627 	.area CONST   (CODE)
                                    628 	.area XINIT   (CODE)
