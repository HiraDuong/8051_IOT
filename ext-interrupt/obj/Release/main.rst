      ...
      000003 02 00 6F         [24]  325 	ljmp	_ISR0
                                    326 ;--------------------------------------------------------
      ...
      000062 02 00 06         [24]  340 	ljmp	__sdcc_program_startup
                                    341 ;--------------------------------------------------------
                                    342 ; Home
                                    343 ;--------------------------------------------------------
                                    344 	.area HOME    (CODE)
      ...
      000065                        360 _main:
                           ...
                           000000   368 	ar0 = 0x00
                                    369 ;	main.c:11: IT0 = 1;
                                    370 ;	assignBit
      000065 D2 88            [12]  371 	setb	_IT0
                                    372 ;	main.c:12: EX0 = 1;
                                    373 ;	assignBit
      000067 D2 A8            [12]  374 	setb	_EX0
                                    375 ;	main.c:13: EA  = 1;
                                    376 ;	assignBit
      000069 D2 AF            [12]  377 	setb	_EA
                                    378 ;	main.c:14: EX0_PIN = 1;
                                    379 ;	assignBit
      00006B D2 B2            [12]  380 	setb	_P3_2
                                    381 ;	main.c:16: while(1);
      00006D                        382 00102$:
                                    383 ;	main.c:18: }
      00006D 80 FE            [24]  384 	sjmp	00102$
                                    385 ;------------------------------------------------------------
                                    386 ;Allocation info for local variables in function 'ISR0'
                                    387 ;------------------------------------------------------------
                                    388 ;	main.c:20: void ISR0() __interrupt IE0_VECTOR
                                    389 ;	-----------------------------------------
                                    390 ;	 function ISR0
                                    391 ;	-----------------------------------------
      00006F                        392 _ISR0:
                                    393 ;	main.c:22: LED_1 = !LED_1;
      00006F B2 A0            [12]  394 	cpl	_P2_0
                                    395 ;	main.c:23: }
      000071 32               [24]  396 	reti
                                    397 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    398 ;	eliminated unneeded push/pop not_psw
                                    399 ;	eliminated unneeded push/pop dpl
                                    400 ;	eliminated unneeded push/pop dph
                                    401 ;	eliminated unneeded push/pop b
                                    402 ;	eliminated unneeded push/pop acc
                                    403 	.area CSEG    (CODE)
                                    404 	.area CONST   (CODE)
                                    405 	.area XINIT   (CODE)
